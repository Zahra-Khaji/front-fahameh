        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50">
              <th className="p-2 text-right font-semibold text-gray-700">شماره</th>
              <th className="p-2 text-right font-semibold text-gray-700">تاریخ ارسال</th>
              <th className="p-2 text-right font-semibold text-gray-700">بازه بازرسی</th>
              <th className="p-2 text-right font-semibold text-gray-700">وضعیت</th>
            </tr>
          </thead>
          <tbody>
            {notifications.map((notification) => (
              <tr key={notification.id} className="border-b border-gray-200 hover:bg-gray-50">
                <td className="p-2 font-semibold">{notification.number}</td>
                <td className="p-2">{formatPersianDate(notification.sendDate)}</td>
                <td className="p-2">{formatDateRange(notification.inspectionRange)}</td>
                <td className="p-2">
