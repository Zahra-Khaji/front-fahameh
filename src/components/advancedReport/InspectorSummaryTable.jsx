...
const InspectorSummaryTable = ({ data, isLoading }) => {
  ...
  // تعریف ستون‌های ثابت با مشخصات کامل
  const columns = [
    { key: "نام بازرس", title: "نام بازرس", type: "string", filterable: true, sortable: false, align: "right" },
    { key: "کد پرسنلی", title: "کد پرسنلی", type: "string", filterable: false, sortable: true, align: "center" },
    { key: "جمع نفر-روز نهایی", title: "جمع نفر-روز نهایی", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
    { key: "قیمت نهایی", title: "قیمت نهایی", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
    { key: "جمع مبلغ نهایی", title: "جمع مبلغ نهایی", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
    { key: "جمع نفر-روز اولیه", title: "جمع نفر-روز اولیه", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
    { key: "قیمت اولیه", title: "قیمت اولیه", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
    { key: "جمع مبلغ اولیه", title: "جمع مبلغ اولیه", type: "number", filterable: false, sortable: true, showSum: true, align: "center" },
  ];
  ...
  // تابع گرفتن text-align بر اساس align ستون
  ...
  // محاسبه مقادیر جمع برای هر ستون عددی
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gradient-to-r from-blue-600 to-blue-500 sticky top-0 z-10 shadow-sm">
                <tr>
                  <th 
                    scope="col" 
                    className="px-3 py-2 text-center text-xs font-medium text-white uppercase tracking-wider whitespace-nowrap"
                    style={{ paddingRight: '24px', width: '50px' }}
                  >
                    ردیف
                  </th>
                  
                  {columns.map((column) => {
                    const isFilterActive = activeFilters[column.key] !== undefined;
                    const textAlign = getTextAlign(column);
                    return (
                      <th 
                        key={column.key}
                        scope="col" 
                        className={`px-3 py-2 ${textAlign} text-xs font-medium text-white uppercase tracking-wider whitespace-nowrap relative`}
                      >
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredAndSortedData.map((item, index) => (
                  ...
                  >
                    <td 
                      className="px-3 py-2 text-center whitespace-nowrap text-xs text-gray-900"
                    ...
                    {columns.map((column) => {
                      ...
                      return (
                        <td 
                          key={column.key}
                          className={`px-3 py-2 whitespace-nowrap text-xs text-gray-900 ${textAlign}`}
                        >
                          {column.type === 'number' 
                ...
                <tr className="bg-gray-100 border-t-2 border-gray-300 font-bold">
                  <td className="px-3 py-2 text-center whitespace-nowrap text-xs font-bold text-gray-900">جمع کل</td>
                  {columns.map((column) => {
                    const textAlign = getTextAlign(column);
                    if (!column.showSum) {
